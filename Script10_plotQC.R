...
# From https://github.com/mfumagalli/ngsTools/blob/master/Scripts/plotQC.R

## To run from command-line, have the R-script in the directory along with the output files
#  from Angsd (bam.qc.arg, bam.qc.depthGlobal, bam.qc.depthSample and bam.qc.qs)
#  Use command: Rscript Script8_plotQC.R bam.qc
